...
public abstract class DefaultJaxbXmlDocumentStructure implements JaxbXmlDocumentStructure {
     ...
     * {@link javax.xml.stream.XMLStreamWriter} based on a given {@link jakarta.xml.bind.JAXBContext}.
     *
     * @param jaxbContext {@link jakarta.xml.bind.JAXBContext} to create this {@code JaxbXmlDocumentStructure} for.
     ...
     * for a writer.
     * @return an {@link JaxbXmlDocumentStructure} instance for the {@link jakarta.xml.bind.JAXBContext}
