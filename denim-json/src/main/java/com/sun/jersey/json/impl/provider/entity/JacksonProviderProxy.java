...
public class JacksonProviderProxy implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    ...
    JacksonXmlBindJsonProvider jaxbProvider = new JacksonXmlBindJsonProvider();
    ...
    public void setProviders(Providers p) {
        ...
        new ComponentInjector<JacksonXmlBindJsonProvider>(new ProvidersInjectableProviderContext(p), JacksonXmlBindJsonProvider.class).inject(jaxbProvider);
    }
