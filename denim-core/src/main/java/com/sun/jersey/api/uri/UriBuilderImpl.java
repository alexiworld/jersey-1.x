...
public class UriBuilderImpl extends UriBuilder {
    ...
    @Override
    public URI buildFromMap(Map<String, ? extends Object> values, boolean encode) throws IllegalArgumentException, UriBuilderException {
        return _buildFromMap(encode, values);
    }
    ...
    @Override
    public URI build(Object[] values, boolean encoded) throws IllegalArgumentException, UriBuilderException {
        return _build(encoded, values);
    }
